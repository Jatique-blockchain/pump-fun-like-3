...
import { linkLibraries } from "@uniswap/hardhat-v3-deploy/src/util/linkLibraries";
...
const artifacts: { [name: string]: ContractJson } = {
    UniswapV3Factory: UniswapV3FactoryArtifact,
    SwapRouter: SwapRouterArtifact,
    NFTDescriptor: NFTDescriptorArtifact,
    NonfungibleTokenPositionDescriptor: NonfungibleTokenPositionDescriptorArtifact,
    NonfungiblePositionManager: NonfungiblePositionManagerArtifact,
    WETH9,
};
